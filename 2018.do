*** recode data set from 2018 codebook
*** no snctmny scntmel, no qlactlm2, qltment, qlthealth. 


    use "brfss2018.dta", clear 

	keep _state iyear genhlth physhlth menthlth poorhlth hlthpln1 persdoc2 medcost checkup1 exerany2 diabete3 cvdinfr4 cvdcrhd4 cvdstrk3 asthma3 asthnow smoke100 educa employ income2  sex drnkany5 alcday5 drnk3ge5 maxdrnks renthom1 _ststr _strwt _raw _race _racegr3 _rfhlth _hcvu65 marital _ageg5yr hlthcvr1 nocov121 
...
if !_rc {
	...
	save "brfss2018_cleaned.dta", replace
